                ...
                <ul class="navbar-nav">
                    <li class="nav-item dropdown" id="myDropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="ventas.php">FACTURA</a></li>
                    ...
                    <li class="nav-item dropdown" id="myDropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="">RECEPCIÓN &raquo;</a>
                                <ul class="submenu dropdown-menu">
                                    <li><a class="dropdown-item" href="recepcion.php">NUEVA</a></li>
                                    <li><a class="dropdown-item" href="recepcion_consulta.php">CONSULTA </a></li>
                                </ul>
                            </li>
                    ...
                    <li class="nav-item dropdown" id="myDropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="cp_filtros2.php">PROVISORIO</a></li>
                        </ul>
                    </li>

                    <li class="nav-item dropdown disabled" id="myDropdown">
                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item dropdown" id="myDropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a class="dropdown-item" href="">RECEPCIÓN &raquo;</a>
                                        <ul class="submenu dropdown-menu">
                                            <li><a class="dropdown-item disabled" href="recepcion.php">NUEVA</a></li>
                                            <li><a class="dropdown-item " href="recepcion_consulta.php">CONSULTA </a></li>
                                        </ul>
                                    </li>
                                    <li> <a class="dropdown-item" href="#"> CATEGORÍAS &raquo; </a>
