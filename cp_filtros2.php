            ...
            <div class="col-lg-6 mb-3">
                <div class="row">
                    <div class="col-md-11 pt-3 text-center">
                        <h5 class="border rounded-2 p-2" style="color: white;">RELACIONAR PROV – CAT – SUBCAT</h5>
                    </div>
                    <div class="col-md-1">
                ...
                <div class="row">
                    <div class="col-lg-6 my-3 pe-4">
                        <form action="relacionar.php" class="border p-3" style="margin-right: -11px;" method="POST">
                            <div style="color: white;" class="form-text">RELACIONAR DATOS</div>
                            <div class="mb-3">
                                <?php
                                $proveedor = mysqli_query($conexion_bd, "SELECT id, nombre 
                                FROM proveedores order by nombre");
                                ?>
                                <select class="form-select" name="relacionarProveedor">
                            ...
                            <div class="mb-3">
                                ...
                                ?>
                                <select class="form-select" name="relacionarCategoria">
                            ...
                            <div class="mb-3">
                                ...
                                ?>
                                <select class="form-select" name="relacionarSubCategoria">
                            ...
                            <button type="submit" class="btn btn-primary form-control p-2">APLICAR</button>
                        </form>
                    </div>
                </div>
            </div>
                        ...
                        <div class="table-wrapper-cp">
                            <table class="table table-striped">
                                ...
                                if ($_SESSION['muestra']) {
                                    ...
                                    $muestra = mysqli_query($conexion_bd, "SELECT id, producto, id_proveedor,
                                    id_cat, id_subCat FROM update_precios");
                                ...
                                ?>
                                        <tbody id="content" class="white">
                                            <tr>
                                                ...
                                                <td><?php echo $id_subCat; ?></td>
                                                <td><a href="elimina_prod2.php?id=<?php echo $cod_interno ?>" style="color:white;" class="btn btn-danger">X</a></td>
                                            </tr>
                                        </tbody>
                                    <?php
                                    }
                                    ...
                                    ?>
                                            <tbody id="content" class="white">
                                                <tr>
                                                    ...
                                                    <td><?php echo $id_cat; ?></td>
                                                    <td><?php echo $id_subCat; ?></td>
                                                    <td><a href="elimina_prod2.php?id=<?php echo $id ?>" style="color:white;" class="btn btn-danger">X</a></td>
                                                </tr>
                                            </tbody>
                                        <?php
                                        }
