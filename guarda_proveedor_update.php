...
" telefono " . $telefono . " movil " . $movil;*/
 ...
 include('conexion.php');
    mysqli_query($conexion_bd, "UPDATE proveedores SET condicion_venta = '$cond_venta', nombre = '$nombre',
 ...
 $_SESSION['proveedor_modificado']="MODIFICADO!!!";
    header("Location: proveedores_modifica.php");
    }
