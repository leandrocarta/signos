            ...
            <div class="col-lg-12 contenedor_gral bg-light">
                <div class="row">
                    <div class="col-md-11 py-4">
                        <h5>MODIFICAR INFORMACION DE CLIENTES</h5>
                    </div>
                    <div class="col-md-1">
                ...
                <form action="guarda_cliente_update.php" method="POST" class="row g-3">
                    <?php
                    $update_cliente = mysqli_query($conexion_bd, "SELECT * FROM clientes WHERE id = '$id'");
                    ...
                    ?>
                        ...
                        <div class="col-md-6">
                            <a href="clientes_modifica.php" type="submit" class="form-control btn btn-danger">CANCELAR</a>
                        </div>
                    <?php
                    }
                    ?>
